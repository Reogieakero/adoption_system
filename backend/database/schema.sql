...
CREATE TABLE health_records (
  ...
  health_status         ENUM('Healthy','Recovering','Under Treatment','Critical') NOT NULL DEFAULT 'Healthy',
  created_by_user_id    INT           NOT NULL,
...
CREATE TABLE animal_reports (
  ...
  status                ENUM('submitted','in_progress','dispatched','resolved') NOT NULL DEFAULT 'submitted',
