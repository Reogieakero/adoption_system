      ...
      {isOpen && (
        <div className={styles.calendarPopoverShadcn}>
          ...
          <div className={styles.calendarHeader}>
            <Button variant="admin-ghost" square className={styles.calendarNavBtn}>
              <ChevronLeft size={14} />
            </Button>
        ...
        {selectedLog && (
          <div className={styles.drawerInner}>
            <div className={styles.drawerHeader}>
              ...
              <Button variant="admin-ghost" square onClick={handleCloseDrawer}>
                <X size={16} />
              </Button>
            </div>
            ...
            <div className={styles.drawerBody}>
              ...
              <div className={styles.metaRowGrid}>
                <div className={styles.metaColumn}>
                  ...
                  <span className={`${styles.moduleInlineBadge} ${styles.fitContentBadge}`}>{selectedLog.module}</span>
                </div>
                <div className={styles.metaColumn}>
                  <div className={styles.metaItemLabelFlex}>
                  ...
                  <span className={`${styles.metaItemValue} ${styles.metaItemValueSmall}`}>{selectedLog.timestamp}</span>
                </div>
              </div>
              ...
              <div className={styles.drawerFullDescriptionBlock}>
                ...
                <div className={`${styles.badgeShadcn} ${styles.badgeFitContent} ${selectedLog.status === "Success" ? styles.badgeSuccess : styles.badgeFailed}`}>
            ...
            <div className={styles.drawerFooter}>
              <Button variant="admin-secondary" onClick={handleCloseDrawer} className={styles.btnFullWidth}>
