  ...
  return (
    <div className={styles.summaryGrid}>
      ...
      <div className={styles.summaryCard}>
        ...
        <div className={`${styles.summaryCardValue} ${styles.valueActive}`}>
          {activeCount}
        </div>
      ...
      <div className={styles.summaryCard}>
        ...
        <div className={`${styles.summaryCardValue} ${styles.valuePending}`}>
          {pendingCount}
        </div>
      ...
      <div className={styles.summaryCard}>
        ...
        <div className={`${styles.summaryCardValue} ${styles.valueSuspended}`}>
          {suspendedCount}
        </div>
