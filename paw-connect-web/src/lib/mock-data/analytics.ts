...
export const performanceMetrics: { label: string; value: string; change: number; icon: any }[] = [
...
export const recentAnalytics: { metric: string; current: string; previous: string; change: number; trend: "up" | "down" }[] = [
