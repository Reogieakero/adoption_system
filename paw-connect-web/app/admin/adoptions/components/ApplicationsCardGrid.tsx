      ...
      {applications.map((app) => (
        <div key={app.id} className={styles.recordItemCard}>
          <div className={styles.recordCardTopRow}>
            <div className={styles.animalProfileCell}>
              ...
              <div>
                ...
                <div className={styles.secondaryCellText}>{app.id} • {app.species.toLowerCase()}</div>
              </div>
            </div>
          ...
          <div className={styles.recordCardBody}>
            ...
            <div className={styles.cardDataField} style={{ marginBottom: '0.5rem' }}>
            ...
            <div className={styles.cardDataField}>
              ...
              <span className={styles.secondaryCellText}>{app.assignedStaff || '—'}</span>
            </div>
          </div>
