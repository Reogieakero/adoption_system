...
// Reusable Custom Shadcn Select Primitives Built natively for module CSS
  ...
  return (
    <div className={styles.selectWrapperShadcn} ref={containerRef}>
      <button
        ...
        className={styles.selectTriggerShadcn}
      >
    ...
    <div className={styles.adminContainer}>
      ...
      <form onSubmit={handleSave}>
        ...
        <div className={styles.tabsListShadcn}>
          <button type="button" onClick={() => setActiveTab("general")} className={`${styles.tabsTriggerShadcn} ${activeTab === "general" ? styles.tabsTriggerActive : ""}`}>General</button>
          <button type="button" onClick={() => setActiveTab("notifications")} className={`${styles.tabsTriggerShadcn} ${activeTab === "notifications" ? styles.tabsTriggerActive : ""}`}>Notifications</button>
          <button type="button" onClick={() => setActiveTab("maps")} className={`${styles.tabsTriggerShadcn} ${activeTab === "maps" ? styles.tabsTriggerActive : ""}`}>Map Specs</button>
          <button type="button" onClick={() => setActiveTab("elearning")} className={`${styles.tabsTriggerShadcn} ${activeTab === "elearning" ? styles.tabsTriggerActive : ""}`}>E-Learning</button>
          <button type="button" onClick={() => setActiveTab("system")} className={`${styles.tabsTriggerShadcn} ${activeTab === "system" ? styles.tabsTriggerActive : ""}`}>System Config</button>
          <button type="button" onClick={() => setActiveTab("security")} className={`${styles.tabsTriggerShadcn} ${activeTab === "security" ? styles.tabsTriggerActive : ""}`}>Security</button>
        </div>
            ...
            <div className={styles.cardShadcn}>
              ...
              <div className={styles.cardContentShadcn}>
                ...
                <div className={styles.backupActionsGrid}>
                  <button type="button" onClick={() => openActionDialog("backup")} className={styles.btnActionUtility}>
                    <Download size={14} /> Backup Database
                  </button>
                  <button type="button" onClick={() => openActionDialog("restore")} className={styles.btnActionUtility}>
                    <Upload size={14} /> Restore Database
                  </button>
                  <button type="button" onClick={() => openActionDialog("export")} className={`${styles.btnActionUtility} ${styles.btnActionFull}`}>
        ...
        <div className={styles.stickyFooterShadcn}>
          <div className={styles.footerFlexContainer}>
            ...
            <div className={styles.footerActionButtonGroup}>
              <button type="button" onClick={handleReset} className={styles.btnSecondaryShadcn}>
                <RotateCcw size={14} /> Reset Changes
              </button>
              <button type="submit" className={styles.btnPrimarySupabase}>
        ...
        <div className={styles.modalOverlay}>
          <div className={styles.modalContent}>
            ...
            <div className={styles.modalFooter}>
              <button type="button" onClick={() => setIsBackupDialogOpen(false)} className={styles.btnSecondaryShadcn}>Abort</button>
              <button type="button" onClick={() => { setIsBackupDialogOpen(false); alert("Instruction pushed into scheduling stack successfully."); }} className={styles.btnPrimarySupabase}>Confirm</button>
            </div>
          </div>
        </div>
      )}
