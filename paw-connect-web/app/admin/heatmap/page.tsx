...
import { useHeatmapData } from '../../hooks/admin/useHeatmapData'
...
export default function HeatmapPage() {
  ...
  return (
    <div className={styles.container}>
        ...
        <div className={styles.toggleGroup}>
          <div className={styles.modeToggle}>
            {VIEW_OPTIONS.map((option) => (
              <button
                key={option.value}
                className={`${styles.modeBtn} ${view === option.value ? styles.modeBtnActive : ''}`}
      ...
      {isLoading && <p className={styles.statusText}>Loading heatmap data…</p>}
      {!isLoading && error && (
